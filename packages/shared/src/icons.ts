...
export const ICONS = {
  ...
  volumeOn: {
    primitives: [
      p('M4 9.5h3.4L12 5.6v12.8L7.4 14.5H4z'),
      p('M15.8 9.4a4 4 0 0 1 0 5.2'),
      p('M18.4 7a7.4 7.4 0 0 1 0 10'),
    ],
  },
  /** 音声案内オフ（スピーカー＋斜線） */
  volumeOff: {
    primitives: [p('M4 9.5h3.4L12 5.6v12.8L7.4 14.5H4z'), l(16, 9.8, 21, 14.2), l(21, 9.8, 16, 14.2)],
  },
  /** 警告（角丸三角＋感嘆符） */
  alert: {
    primitives: [
      p('M12 3.6 21.2 19.4a1.4 1.4 0 0 1-1.2 2.1H4a1.4 1.4 0 0 1-1.2-2.1Z'),
      l(12, 9.6, 12, 14.4),
      c(12, 17.4, 0.75, true),
    ],
  },
